...
export const CareerInfoCard: React.FC<CareerInfoCardProps> = ({ text, tag, years, onCardClick, selected }) => {
  const customClass = selected ? 'bg-purpleText text-white lg:w-[250px] w-full rounded-[10px] cursor-pointer flex flex-col justify-center items-center lg:min-h-[200px] text-sm lg:text-base font-medium text-center py-5' : 'border-2 border-purpleText hover:bg-cardHover lg:w-[250px] w-full rounded-[10px] cursor-pointer flex flex-col justify-center items-center lg:min-h-[200px] text-purpleText text-sm lg:text-base font-medium text-center py-5'
  return (
