        ...
        <div className="flex flex-col lg:h-[695px]">
          ...
          <div>
            <button
              ...
              className="w-full lg:w-auto text-white bg-landing-page hover:bg-landing-page-reverse focus:ring-1 focus:outline-none focus:ring-purple-200 font-bold rounded-lg text-[16px] lg:text-sm px-5 py-2.5 text-center me-2 mb-2 mt-7 z-10 cursor-pointer relative"
              >
        ...
        <div className="overflow-x-hidden space-y-7 lg:space-y-14 lg:my-14 lg:mt-[30rem]">
          ...
          <div className="flex justify-center gap-5">
              <TeamCard 
                ...
                fact="I love to travel and collect pins from places I have visited!" link="https://www.linkedin.com/in/juancarlosyao" 
              />
              <TeamCard 
                image={jon} 
                name="Jon Chiang" 
                title="Product Designer" 
                fact="I love any and all racket sports including badminton, tennis, and pickleball!" link="https://www.linkedin.com/in/jmchiang5" 
              />
              <TeamCard 
                image={jay} 
                name="Juan Hernandez" 
                title="Developer" 
                fact="I have a twin sister and she is 1 minute older!" link="http://linkedin.com/in/j-hernandez-dev" 
              />
              <TeamCard 
                image={me} 
                name="John Clapper" 
