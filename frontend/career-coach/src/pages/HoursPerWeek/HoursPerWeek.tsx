  ...
  return (
    <div className="flex justify-center min-h-screen">
      <div className="flex flex-col items-center w-full mt-28">
        <p className="text-purpleText text-center text-base lg:text-xl font-bold leading-[45px] lg:leading-[60px]">How many <span className="bg-hours-per-week gradient-text">hours per week</span> can you dedicate?</p>
