  ...
  return (
    <div className="flex justify-center items-center w-full">
        <div className="flex flex-col items-center w-full">
            <div className=" text-center gradient-text bg-blurred-content font-semibold text-base mt-7 w-full">
            ...
            <div className="flex flex-col items-center blur mt-10 w-full">
